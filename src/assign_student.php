...
<title>Assign Student — Internship Management</title>
...
.sidebar-footer {
  ...
  .student-preview.visible { display: flex; }
  .preview-avatar {
  ...
  .preview-sub { font-size: 12px; color: var(--muted); margin-top: 2px; font-family: var(--mono); }
  .preview-badge {
    margin-left: auto;
    padding: 3px 10px;
    border-radius: 99px;
...
<main class="main">
  ...
  <!-- Form card -->
  <form action="assign_student_handler.php" method="POST" onsubmit="return submitForm()">
    ...
    <div class="form-section">
      ...
      <div class="form-grid">
        <div class="field">
          ...
          <select id="studentId" name="student_id" onchange="onStudentChange()">
			  <option value="">— Select student —</option>
			</select>
          <div class="err-msg" id="err-student">
          ...
          <div class="student-preview" id="studentPreview">
            ...
            <span class="preview-badge badge-unassigned" id="previewBadge">Unassigned</span>
          </div>
        </div>
        <div class="field">
          <label>Programme</label>
          <input type="text" id="programme" name="programme" placeholder="Auto-filled from student record" readonly style="opacity:0.6; cursor:not-allowed;">
    ...
    <div class="form-section">
      ...
      <div class="form-grid">
        ...
        <div class="field full">
          ...
          <textarea id="notes" name="notes" placeholder="Any extra details about this internship placement…"></textarea>
          <div class="err-msg"></div>
        </div>
      </div>
    </div>
